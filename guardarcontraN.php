...
/*FIN: CONEXION A LA BD*/
	  ...
	  /*INICIO= RETENCIONES*/
	    ...
	    $resultChe= $con->ejecutar("SELECT * FROM transacciones WHERE nrocheque='$ncheque' and nrocontrato='$contra'",$idcon);
  	    $num_cheque=mysql_num_rows($resultChe);
	    if ($num_cheque == 1){
            js_redireccion("error.php?msn=Número de Cheque Invalido");
		    exit;
		}
