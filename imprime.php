...
if ($_SESSION['imp'] == 0){
   ...
   /*INICIO: ACTUALIZAR LA TABLA acreditado*/
       $hoy = date("Y-m-d");
       $strStatus = "UPDATE acreditado SET cod_b = '$codigoa', estatus='2',fecha_i='$hoy' WHERE cod_b='".$row[cod_b]."'";
...
?>
	<div align="center" style="width:50mm; height:85mm; font-family:Arial, Helvetica, sans-serif; font-size:9px; background: url(Imagenes/rotativo.jpg); vertical-align:middle">
		 ...
		 <tr>
		 <td width="50%">&nbsp;</td><font style="font-family:Arial, Helvetica, sans-serif; font-size:9px"
		 <td valign="middle" align="center">
		  <?PHP
		  echo "<font style='font-family:Arial, Helvetica, sans-serif; font-size:9px'><strong>".$row['nombre'].'</strong></font><br>';			  
		  echo "<font style='font-family:Arial, Helvetica, sans-serif; font-size:12px'><strong>".$row2['descrip'].'</strong></font><br>';
		  echo "<font style='font-family:Arial, Helvetica, sans-serif; font-size:9px'>".$empresa.'</font><br><br>';
		  echo "<img src='barcode.php?code=C".$row['cod_b']."' width='120' height='50'>";
		  ?>
		  </td>
		  </tr>
		  </table>
...
?>
	<div align="center" style="width:50mm; height:85mm; font-family:Arial, Helvetica, sans-serif; font-size:9px; background: url(Imagenes/inv_esp.jpg); vertical-align:middle">
		 <table border="0" style="height:85mm">
		 <tr>
		 <td width="50%">&nbsp;</td><font style="font-family:Arial, Helvetica, sans-serif; font-size:9px"
		 <td valign="middle" align="center">
