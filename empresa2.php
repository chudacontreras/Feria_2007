<?php
/**************************************************************************************
           CONSULTA EMPRESA PARA ACREDITACION (USUARIOS DE LA ALCALDIA)
**************************************************************************************/
session_start();
  ...
  <div align="center">
      <strong>
		     <font face="Arial, Helvetica, sans-serif" size="4" color="#FF6600">
		          <br>Registro de Acreditaciones
		          <br>
			 </font>	  
		     <font face="Arial, Helvetica, sans-serif" size="2" color="#FF6600">
		          <br>Consulta de Empresas
		          <br><br>
			 </font>
	</strong>
  </div>
  <div id="contenido">
  <FORM METHOD="GET" action="acremp.php">
  ...
  <!--DWLayoutTable-->
			...
			<tr>
			  <td height="28" colspan="2" valign="top" align="center">
                <br><input name="button" type="submit" value="Consultar">
				</td>
		    </tr>	
			<tr>
			  <td height="28" colspan="2" valign="top" align="center">
