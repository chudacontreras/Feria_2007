...
<div align="center">
      <strong>
	    <font face="Arial, Helvetica, sans-serif">
		   <span>
		     <font size="4">
			   <font color="#FF6600">
		          <br>Disponibilidad por Ubicaci&oacute;n
		          <br>
			   </font>
			 </font>
		</span>
   ...
   <FORM METHOD="POST" action="disporepor.php" name="formulario">
  <?php
			...
			<tr>
		        ...
		        <?php
					...
					if ($row = mysql_fetch_array($result)){ 
                        echo '<select name= "ubi" id="ubi" style="WIDTH: 290px; HEIGHT: 22px" >';
                      do {
			  ...
			  <td height="28" colspan="4" align="center" valign="top">
                <input name="button" type="submit" value="Ver Reporte">				
			</td>
