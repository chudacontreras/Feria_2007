...
include("ControlaBD.php");
              ...
              if ($num_rows>=1){
				...
				<tr>&nbsp;</tr>
				   ...
				   <td colspan=5 align='center'><input type='submit' name='hacer' value='Ver Contratos' ></td>
					</tr>";
		      }else{
