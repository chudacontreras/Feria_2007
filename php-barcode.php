...
function barcode_outimage($text, $bars, $scale = 1, $mode = "png",
    ...
    if ($mode=='jpg' || $mode=='jpeg')
        ...
        $transparente = imagecolortransparent ($im,$col_bg);
		...
		elseif ($mode=='gif')
         ...
         imagefill($im,0,0,$transparente);
              ...
              $transparente = imagecolortransparent ($im,$col_bg);
              imagefill($im,0,0,$transparente);
							//$ime = imagecreatefrompng($im);
              //imagepng($ime,"salida.png");
              imagepng($im);
...
function barcode_outimage2($text, $bars, $scale = 1, $mode = "png",
	    $total_y = 0, $space = ''){
    global $bar_color, $bg_color, $text_color;
    global $font_loc;
    /* set defaults */
...
function barcode_print($code, $encoding="ANY", $scale = 2 ,$mode = "png" ){
    ...
    elseif (eregi($mode,"^(html|htm)$")) print barcode_outhtml($bars['text'],$bars['bars'], $scale,0, 0);
		     ...
		     barcode_outimage2($bars['text'],$bars['bars'],$scale, $mode);
