...
function Validar()
   {
      var ubi = document.formulario.ubi.value; 
...
<div align="center">
   ...
   <FORM METHOD="GET" action="buscarubi.php" name="formulario" onSubmit="return Validar()">
  <?php
...
<table align="center" cellspacing="2" cellpadding="2" border="0" class="texto">
 	     <tr>
			    ...
			    <td>
		        <?php
				    $result= $con->ejecutar("SELECT codubi,descrip,costo,cant,metros FROM ubicacion",$idcon);
					if ($row = mysql_fetch_array($result)){ 
                        echo '<select name= "ubi" id="ubi" style="WIDTH: 220px; HEIGHT: 22px" ><option value=0>Seleccione la Ubicaci&oacute;n</option>';
                      do {
		        ...
		        ?>
				 ...
				 <td height="21" colspan="3" valign="top"><input name=button type=submit value='Modificar'></td>
		   </tr>			
</table>
</form>
  </div>
