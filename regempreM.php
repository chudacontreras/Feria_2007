...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  $iva=0;
	...
	if ($nacionalidad=='G' or $nacionalidad=='J'){
	    ...
	    $strsql = "UPDATE empresa set nombre ='$nombre',direccion='$direccion',telf='$telefono',replegal='$repre',cedrepre='$cedrepre',regismercan='$regis',fecharegis='$fecregis',nrotomo='$tomo',cargo='$cargo' where rif='$dato'";
		$resultbusq = $con->ejecutar($strsql,$idcon);
	   }
	   else{
	 $strsql = "UPDATE empresa set nombre='$nombre',direccion='$direccion',telf='$telefono' where rif='$dato'";
	 $resultbusq = $con->ejecutar($strsql,$idcon);
	   }
		if (!$resultbusq) {
      ...
      <strong>
	    <font face="Arial, Helvetica, sans-serif">
		   <span>
		     <font size="4">
			   <font color="#FF6600">
		          <br>La Empresa Modificada Existosamente....
		          <br>
			   </font>
			 </font>
		</span>
