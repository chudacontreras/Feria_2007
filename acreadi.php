...
<div align="center">
      <strong>
	    <font face="Arial, Helvetica, sans-serif">
		   <span>
		     <font size="3">
			   <font color="#FF6600">
		          <br>Consultar Empresa o Comisión
		          <br>
			   </font>
			 </font>
		</span>
   ...
   <FORM METHOD="GET" action="resulempreacred.php" name="formulario">
  <?php
...
<table align="center" cellspacing="2" cellpadding="2" border="0" class="texto">
  <!--DWLayoutTable-->
			...
			<tr>
			    <td width="162">Empresa o Comision:&nbsp;</td>
				 <td width="302">
				    <INPUT type="Text" name=Emp id="Emp"  style="WIDTH: 200px; HEIGHT: 22px">				
				</td>
			</tr>
			<tr>
